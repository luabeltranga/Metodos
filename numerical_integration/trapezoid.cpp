...
int main(void){
  ...
  int n = 20;
  std::cout<<"Integral con n=20 por trapezoide: "<< trapezoid(f,0,M_PI,n) <<std::endl;
  std::cout<<"Integral con n=20 por trapezoide con richardson: "<< richardson(f,0,M_PI,n) <<std::endl;
